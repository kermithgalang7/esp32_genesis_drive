...
#define TEST_DEVICE_NAME            "CamCrusher"
...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_READ_EVT: {
        ...
        rsp.attr_value.value[0] = status_from_esp32_to_user(0);
        rsp.attr_value.value[1] = status_from_esp32_to_user(1);
        rsp.attr_value.value[2] = status_from_esp32_to_user(2);
        rsp.attr_value.value[3] = status_from_esp32_to_user(3);
#if 0
